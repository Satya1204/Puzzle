...
namespace DeskCat.FindIt.Scripts.Editor
{
    ...
    public class HiddenObjEditor : UnityEditor.Editor
    {
        ...
        private AnimBool particleFxBool;
        ...
        private void OnEnable()
        {
            ...
            particleFxBool = new AnimBool(true);
            particleFxBool.valueChanged.AddListener(Repaint);
        ...
        {
            HiddenObjTarget.baseInfoBool =
                EditorGUILayout.BeginFoldoutHeaderGroup(HiddenObjTarget.baseInfoBool, "General Setting");
            ...
            if (EditorGUILayout.BeginFadeGroup(baseInfoAnimBool.faded))
            {
                EditorGUI.indentLevel++;
                {
                    ...
                    HiddenObjTarget.isClickActionTrigger =
                        EditorGUILayout.ToggleLeft("Trigger Found Event When Click",
                            HiddenObjTarget.isClickActionTrigger);
        ...
        {
            HiddenObjTarget.tooltipsBool =
                EditorGUILayout.BeginFoldoutHeaderGroup(HiddenObjTarget.tooltipsBool, "Tooltips Setting");
        ...
        {
            HiddenObjTarget.bgAnimBool =
                EditorGUILayout.BeginFoldoutHeaderGroup(HiddenObjTarget.bgAnimBool, "Clicked Background Animation");
                ...
                EditorGUILayout.BeginHorizontal();
                {
                    ...
                    if (GUILayout.Button("Clean", EditorStyles.miniButtonRight))
                    {
                        ...
                        if (HiddenObjTarget.BgAnimationTransform)
                            DestroyImmediate(HiddenObjTarget.BgAnimationTransform.gameObject);
        ...
        private void DrawParticleFx()
        {
            HiddenObjTarget.particleFxBool =
                EditorGUILayout.BeginFoldoutHeaderGroup(HiddenObjTarget.particleFxBool, "Clicked Particle Fx");
            particleFxBool.target = HiddenObjTarget.particleFxBool;

            if (EditorGUILayout.BeginFadeGroup(particleFxBool.faded))
            {
                EditorGUI.indentLevel++;

                EditorGUILayout.BeginHorizontal();
                {
                    HiddenObjTarget.EnableParticleFx =
                        EditorGUILayout.ToggleLeft("Enable Particle Fx", HiddenObjTarget.EnableParticleFx);
                }
                EditorGUILayout.EndHorizontal();


                if (HiddenObjTarget.EnableParticleFx)
                {
                    EditorGUILayout.BeginHorizontal();
                    {
                        HiddenObjTarget.ParticleFxPrefab = (GameObject)EditorGUILayout.ObjectField("Particle Prefab",
                            HiddenObjTarget.ParticleFxPrefab, typeof(GameObject), false);
                    }
                    EditorGUILayout.EndHorizontal();

                    EditorGUILayout.BeginHorizontal();
                    {
                        HiddenObjTarget.ParticleFxLifespan = EditorGUILayout.FloatField("Lifespan", HiddenObjTarget.ParticleFxLifespan);
                    }
                    EditorGUILayout.EndHorizontal();
                }
        ...
        {
            HiddenObjTarget.actionFoldoutBool =
                EditorGUILayout.BeginFoldoutHeaderGroup(HiddenObjTarget.actionFoldoutBool, "Show Action Utility");
